...
const ShowCart = ({item}) => {
    const { brand_name,detail,image,name,price,rating,title,type } = item;
    return (
        ...
        //                 <img className="flex-shrink-0  w-20 h-20 dark:border-transparent rounded outline-none sm:w-32 sm:h-32 dark:bg-gray-500" src={image} alt="Polaroid camera" />
        //                 <div className="flex flex-col justify-between w-full pb-4">
        //                     <div className="flex justify-between w-full pb-2 space-x-2">
        //                         <div className="space-y-1">
        //                             <h3 className="text-lg font-semibold leadi sm:pr-8">{brand_name}- <span className="text-sm text-stone-900 bg-red-100 px-1 rounded ">{ type}</span></h3>
        //                             <p className="text-sm dark:text-gray-400 uppercase  font-semibold">{ name}</p>
        //                         </div>
        ...
        //                         <button type="button" className="flex items-center btn btn-outline btn-sm btn-warning mr-1">

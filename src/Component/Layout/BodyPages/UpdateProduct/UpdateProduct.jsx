...
const UpdateProduct = () => {
    ...
    const { name, type, price, detail, brand_name, title, rating, image, thumbnail_img, _id } = carData;
    ...
    const handleSubmit = e => {
        ...
        // https://brand-shop-server-nu.vercel.app/detail/65315fb12f7ba1abbb8a792f
        // send data to the server 
        fetch(`https://brand-shop-server-nu.vercel.app/detail/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div>
            <div className="text-center md:my-10 w-10/12 mx-auto">
                <h1 className="text-4xl font-bold ">Update the {name} !</h1>
            ...
            <div className="my-6 ">
                <section className="w-10/12 md:max-w-xl p-8 md:px-10 mx-auto bg-gradient-to-t from-stone-900 via-red-800 to-neutral-400 rounded-md shadow-md dark:bg-gray-800">
